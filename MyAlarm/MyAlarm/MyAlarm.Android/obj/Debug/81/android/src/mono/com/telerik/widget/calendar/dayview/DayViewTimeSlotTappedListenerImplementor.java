...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onTimeSlotTapped:(JJJ)V:GetOnTimeSlotTapped_JJJHandler:Com.Telerik.Widget.Calendar.Dayview.IDayViewTimeSlotTappedListenerInvoker, Telerik.Xamarin.Android.Input\n" +
			"";
	...
	public void onTimeSlotTapped (long p0, long p1, long p2)
	{
		n_onTimeSlotTapped (p0, p1, p2);
	}

	private native void n_onTimeSlotTapped (long p0, long p1, long p2);
